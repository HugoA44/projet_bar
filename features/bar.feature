Feature:
    ...
    Scenario: J’ajoute un produit
        ...
        When J’ajoute le produit "Coca-Cola"
        Then Le produit "Coca-Cola" a été ajouté
...
Feature:
    ...
    Scenario: Je supprime un produit
        Given Je suis connecté en "administrateur"
        When Je supprime le produit "Coca-Cola"
        Then Le produit "Coca-Cola" a été supprimé
...
Feature:
    ...
    Scenario: Je modifie un produit
        Given Je suis connecté en "administrateur"
        When Je modifie le produit "Coca-Cola"
        Then Le produit "Coca-Cola" a été modifié
...
Feature:
    ...
    Scenario: J'essaye d'ajouter un produit sans être administrateur
        ...
        When J’ajoute le produit "Coca-Cola"
        Then Le produit "Coca-Cola" n'a pas pu être ajouté
...
Feature:
    ...
    Scenario: Je commande un produit
        Given Je suis connecté en "utilisateur"
        When Je commande le produit "Coca-Cola"
        Then Le produit "Coca-Cola" a été commandé
